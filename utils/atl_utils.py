...
def get_atl08_class_to_atl03(atl03_file, atl08_file, beam_label):
    ph_index_beg, segment_id = read_atl03_data_mapping(atl03_file, beam_label)
    classed_pc_indx, classed_pc_flag, classed_index_seg, _ = read_atl08_data_mapping(atl08_file, beam_label)
...
def get_atl08_norm_h_to_atl03(atl03_file, atl08_file, beam_label):
    ph_index_beg, segment_id = read_atl03_data_mapping(atl03_file, beam_label)
    classed_pc_indx, _, classed_index_seg, ph_h = read_atl08_data_mapping(atl08_file, beam_label)
